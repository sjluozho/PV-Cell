...
# -*- coding: utf-8 -*-
#
# PV_Cell documentation build configuration file, created by
...
latex_documents = [
  ('index', 'PV_Cell.tex', 'PV_Cell Documentation',
   'Ariel Rokem', 'manual'),
]
...
man_pages = [
    ('index', 'PV_Cell', 'PV_Cell Documentation',
     ['Ariel Rokem'], 1)
]
...
texinfo_documents = [
  ('index', 'PV_Cell', 'PV_Cell Documentation',
   'Ariel Rokem', 'PV_Cell', 'One line description of project.',
   'Miscellaneous'),
]

"""
This module extract chemical information from given SMILES_Str and could
automatically eliminate invalid feature (non-numeric).
"""
...
def missing_value_list(features_df):
    """
...
def replace_missing(features_df):
    """
...
def seek_feature_with_replacement(data):
    """
    This function wrapps the three functions above, allowing users to extract
    features and replace invalid features in one step.
    ...
    """
    features_df = chem_features(data)
    features_df_n = replace_missing(features_df)
    return features_df_n

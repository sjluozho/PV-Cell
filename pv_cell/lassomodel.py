...
def lasso_plot(X, y, a=None, b=None):
    ...
    coefs_LASSO = lasso_regress(X, y, a, b)[0]
    lambdas_LASSO = lasso_regress(X, y, a, b)[1]
    error1_LASSO = lasso_regress(X, y, a, b)[2]
    error2_LASSO = lasso_regress(X, y, a, b)[3]
    ...
    plt.title(r'LASSO coefs vs $\lambda$')
    plt.xlim(1e-4, 1e8)

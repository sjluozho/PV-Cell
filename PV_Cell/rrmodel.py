...
def rr_plot(X, y, a=None, b=None):
    ...
    coefs_RR = rr_regress(X, y, a, b)[0]
    lambdas_RR = rr_regress(X, y, a, b)[1]
    error1_RR = rr_regress(X, y, a, b)[2]
    error2_RR = rr_regress(X, y, a, b)[3]
    ...
    plt.title(r'RR coefs vs $\lambda$')
    plt.xlim(1e-4, 1e8)
